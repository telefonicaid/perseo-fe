...
| PERSEO_MAX_RULES_BY_CORR | Maximun number of rules with the same correlator until refuse execute a rule. Default is 20. See [loop detection tips](https://github.com/telefonicaid/perseo-fe/blob/master/docs/architecture/architecture.md#loop-detection)
|
