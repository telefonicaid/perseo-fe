...
| PERSEO_MONGO_URI                     | URI for Mongo DB. This option overrides the Mongo options below, which have been deprecated. Mongodb URI format is available in `http://mongodb.github.io/node-mongodb-native/driver-articles/mongoclient.html`                                                               |
| PERSEO_MONGO_ENDPOINT                | Endpoint (`host[:port]`) list for Mongo DB.                                                                                                                                                                                                                                   |
| PERSEO_MONGO_DB_NAME                 | Mongo Data Base name (default value is `cep`).                                                                                                                                                                                                                                |
...
| PERSEO_SMTP_TLS_CA                   | CA to override the trusted CA certificates. Default is empty. Check more detail in https://nodejs.org/api/tls.html#class-tlstlssocket                                                                                                                                         |
| PERSEO_SMTP_TLS_KEY                  | Private keys in PEM format. Default is empty. Check more detail in https://nodejs.org/api/tls.html#class-tlstlssocket                                                                                                                                                         |
| PERSEO_SMTP_TLS_CERT                 | Cert chains in PEM format. Default is empty. Check more detail in https://nodejs.org/api/tls.html#class-tlstlssocket                                                                                                                                                          |
| PERSEO_SMTP_TLS_MIN_VERSION          | Optionally set the minimum TLS version to allow. One of 'TLSv1.3', 'TLSv1.2', 'TLSv1.1', or 'TLSv1'. Check more detail in https://nodejs.org/api/tls.html#class-tlstlssocket                                                                                                  |
| PERSEO_SMTP_TLS_SERVER_NAME          | Server name for the SNI (Server Name Indication) TLS extension. Check more detail in https://nodejs.org/api/tls.html#class-tlstlssocket                                                                                                                                       |
...
| PERSEO_SMPP_DEFAULT_COUNTRY_CODE     | SMPP default country code (e.g., '34' for Spain)                                                                                                                                                                                                                              |
...
| PERSEO_NON_SIGNAL_MAX_TIME_DETECTION | Max time detection for check nonSignal rules by mongo in seconds                                                                                                                                                                                                              |
...
-   `config.smpp.defaultCountryCode`: SMPP default country code (e.g., '34' for Spain).
