    ...
    d.run(function() {
        ...
        async.series(
            [
                ...
                db.orionPing,
                function(callback) {
                    var domainVar = require('domain').create();
                    domainVar.context = {};
                    domainVar.context.op = 'initialRefresh';
                    domainVar.context.comp = constants.COMPONENT_NAME;
                    domainVar.context.trans = 'n/a';
                    domainVar.context.corr = domainVar.context.trans;
                    domainVar.context.srv = 'n/a';
                    domainVar.context.subsrv = 'n/a';
                    domainVar.run(function() {
