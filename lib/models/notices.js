...
function parseLocation(locStr) {
    ...
    if (typeof position !== 'string') {
        return new errors.InvalidLocation();
    }
        ...
        for (var attr in attrList) {
            ...
            if (attr !== 'id' && attr !== 'type') {
                ...
                if (attrInfo.type === 'geo:point') {
                    n[attr] = parseLocation(attrInfo.value);
                ...
                if (attrInfo.metadata) {
                    ...
                    for (var metaKey in  attrInfo.metadata) {
                        ...
                        var metadatum = attrInfo.metadata[metaKey];
                        n[attr + '__metadata__' + metaKey + '__type'] = metadatum.type;
                        if (metadatum.type === 'DateTime') {
                            n[attr + '__metadata__' + metaKey] = parseDate(metadatum.value);
                        } else if (metadatum.type === 'geo:point') {
                            n[attr + '__metadata__' + metaKey] = parseLocation(metadatum.value);
                        } else {
                            n[attr + '__metadata__' + metaKey] = metadatum.value;
                        }
