        ...
        for (var attr in attrList) {
            ...
            if (attr !== 'id' && attr !== 'type') {
                ...
                if (attrInfo.type === 'geo:point') {
                    n[attr] = parseLocation2GeoJSON(attrInfo.value);
                ...
                if (attrInfo.metadata) {
                    ...
                    for (var metaKey in  attrInfo.metadata) {
                        ...
                        if (attrInfo.metadata[metaKey].type === 'DateTime') {
                            n[attr + '__metadata__' + metaKey] = parseDate(attrInfo.metadata[metaKey].value);
                        } else if (attrInfo.metadata[metaKey].type === 'geo:point') {
                            n[attr + '__metadata__' + metaKey] = parseLocation2GeoJSON(attrInfo.metadata[metaKey].value);
                        } else {
