...
function buildUpdateOptions(action, event) {
    ...
    if (action.parameters.authentication !== undefined) {
        options.authentication.host = myutils.expandVar(action.parameters.authentication.host, event);
        options.authentication.port = myutils.expandVar(action.parameters.authentication.port, event);
        options.authentication.user = myutils.expandVar(action.parameters.authentication.user, event);
        options.authentication.password = myutils.expandVar(action.parameters.authentication.password, event);
    }
