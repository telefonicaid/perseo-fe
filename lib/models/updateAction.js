...
function buildUpdateOptions(action, event) {
    ...
    action.parameters.service = action.parameters.service || '${service}';
    action.parameters.subservice = action.parameters.subservice || '${subservice}';
    ...
    options = {
        ...
        service: myutils.expandVar(action.parameters.service, event),
        subservice: myutils.expandVar(action.parameters.subservice, event)
    };
