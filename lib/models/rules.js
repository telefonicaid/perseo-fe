...
module.exports = {
    FindAll: function(tenant, subservice, callback) {
        rulesStore.FindAll(tenant, subservice, function(err, data) {
    ...
    Save: function(rule, callback) {
        ...
        async.series(
            [
                ...
                function(cb) {
                    if (rule.nosignal) {
                        noSignal.AddNSRule(rule.tenant, rule.subservice, rule.name, rule.nosignal);
                    }
                    cb(null);
                }
            ],
    ...
    Remove: function(rule, callback) {
        async.series(
            [
                ...
                function(cb) {
                    noSignal.DeleteNSRule(rule.tenant, rule.subservice, rule.name);
                    cb(null);
                }
            ],
            callback
