...
function findSilentEntitiesByAPI(service, subservice, ruleData, func, callback) {
    var context = { op: 'checkNoSignal', comp: constants.COMPONENT_NAME };
    ...
    var filter = {
        id: ruleData.id,
        type: ruleData.type,
        idPattern: ruleData.idRegexp ? ruleData.idRegexp : '.*'
        /*
          ruleData.attribute
          ruleData.reportInterval
        */
    };
    logger.debug(context, 'find silent entities by API ngsi using options %j and fileter %j', options, filter);
