...
function createFilter(ruleData, service, subservice, limit, offset) {
    var filter = {
        ...
        // + ';' + 'temperature.dateModified>' + currentT.toString()  + '- maxTimeDetection.value'
        limit: limit,
        offset: offset
    };
    if (ruleData.id) {
                ...
                var pipeline = [
                    ...
                    },
                    {
                        $addFields: {
                            ...
                            maxTimeDetection: {
                                $toDouble: {
                                    $ifNull: ['$attrs.maxTimeDetection.value', config.nonSignalMaxTimeDetection]
                                }
                            },
