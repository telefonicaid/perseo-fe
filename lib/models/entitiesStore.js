...
function findSilentEntities(service, subservice, ruleData, func, callback) {
    if (!config.nonSignalByAPI) {
        return this.FindSilentEntitiesByMongo(service, subservice, ruleData, func, callback);
    } else {
        return this.FindSilentEntitiesByAPI(service, subservice, ruleData, func, callback);
    }
}

module.exports = {
    FindSilentEntities: findSilentEntities,
    FindSilentEntitiesByAPI: findSilentEntitiesByAPI,
    FindSilentEntitiesByMongo: findSilentEntitiesByMongo
};
