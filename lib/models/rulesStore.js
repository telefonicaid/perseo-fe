...
function findAll(service, subservice, callback) {
    ...
    myutils.collectionExists(db, rulesCollectionName, function(exists) {
        ...
        var col = db.collection(rulesCollectionName);
...
module.exports = {
    ...
    Save: function Save(r, callback) {
        ...
        myutils.collectionExists(appContext.Db(), rulesCollectionName, function(exists) {
            ...
            var operation;
            if (r._id) {
                operation = col.updateOne({ _id: r._id }, r);
            } else {
                operation = col.insertOne(r);
            }
            operation
                .then(function(result) {
        ...
        myutils.collectionExists(appContext.Db(), rulesCollectionName, function(exists) {
            ...
            col.findOneAndUpdate(
                ...
                .then(function(result) {
                    ...
                    parsePostAxnParams(result.value);
                    logger.debug('rulesStore.findOneAndUpdate %s', myutils.firstChars(result.value));
