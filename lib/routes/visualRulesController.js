...
var visualRules = require('../models/visualRules'),
...
function GetVR(req, resp) {
    ...
    logger.debug({}, 'getting Vrule %j', rule);
...
function PostVR(req, resp) {
    ...
    logger.info({}, 'posting Vrule %j', req.body);
...
function DelVR(req, resp) {
    ...
    logger.info({}, 'deleting Vrule %j', rule);
...
function PutVR(req, resp) {
    ...
    req.body.subservice = req.subservice;
    req.body.service = req.service;
    logger.info({}, 'putting Vrule %j', req.body);
